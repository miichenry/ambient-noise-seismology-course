...
# Load pick table
picks = pd.read_csv("/srv/beegfs/scratch/users/h/henrymi/campiglia_data/postprocessing/picking_csv/phaseonly_rma_snr5.0_dlambda1.0.csv")

# Define some plotting parameters
Tmin = 0.05 # minimum period
